...
The program scans a specified music directory for MP3 files and builds a lookup table using selected metadata fields. The metadata fields used to determine duplicates are specified in `config.txt`.
